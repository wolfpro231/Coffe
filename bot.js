...
client.on('message', message => {
  ...
  if (message.content.startsWith(prefix + 'pl')) {
    client.user.setGame(argresult);
     ...
     if (message.content === (prefix + "hajcjss")) {
    message.guild.leave();        
  } else  
  if (message.content.startsWith(prefix + 'wt')) {
  client.user.setActivity(argresult, {type:'WATCHING'});
      message.channel.send(`** ${argresult}  تم تغيير بلاينق الي**`)
  } else
  if (message.content.startsWith(prefix + 'ls')) {
  client.user.setActivity(argresult , {type:'LISTENING'});
      message.channel.send(`**${argresult} تم تغيير ليسنينق الي**`)
  } else
  if (message.content.startsWith(prefix + 'tw')) {
    client.user.setGame(argresult, "https://www.twitch.tv/ii7m0dy");
      message.channel.send(`**تم تغيير التويتش **`)
  }
  if (message.content.startsWith(prefix + 'setna')) {
  client.user.setUsername(argresult).then
      message.channel.send(`**${argresult} تم تغيير الاسم الي** `)
} else
if (message.content.startsWith(prefix + 'setav')) {
  client.user.setAvatar(argresult);
    message.channel.send(`**${argresult} تم تغيير الصورة الي** `);
}
});
...
if(message.channel.type === 'dm') return;
 ...
 .setDescription(`
 -=-=-=-=-=-=-=-=-=-=
 🎖 لارسال برودكاست لرتبة معينة بدون امبيد
 
 🏅 لارسال برودكاست لرتبة معينة مع امبيد
 
 📭 لارسال برودكاست لكل اعضاء السيرفر مع امبيد
 
 📧 لارسال برودكاست لكل اعضاء السيرفر بدون امبيد
 
 🔵 لارسال برودكاست للاونلاين بدون امبيد
 
 🔷 لارسال برودكاست للاونلاين مع امبيد
 ...
 embedonlineonly.on('collect', r => {
    ...
    let msge;
    message.channel.send(':pencil: **| اكتب الرسالة المطلوب ارسالها :pencil2: **').then(msg => {
           ...
           .then(collected => {
               ...
               msg.edit('✅ **| هل تريد منشن مع الرسالة [yes OR no] **').then(msg => {
                 message.channel.awaitMessages(filter, {
                   max: 1,
                   time: 90000,
                   errors: ['time']
   ...
   message.channel.send(`**:white_check_mark: تم ارسال الرسالة بنجاح :loudspeaker:**`);
 ...
 embedonlyrole.on('collect', r => {
     ...
     message.channel.send(':pencil: **| اكتب الرسالة المطلوب ارسالها :pencil2: **').then(msg => {
         ...
         .then(collected => {
             ...
             role = collected.first().content;
                 let rolecheak = message.guild.roles.find('name', `${role}`)
             msg.edit('✅ **| تريد ارسال منشن مع الرسالة[yes OR no] **').then(msg => {
               message.channel.awaitMessages(filter, {
                 max: 1,
                 time: 90000,
                 errors: ['time']
